<?php
    ...
    if (!isset($_SESSION['gdusername']) and !isset($_SESSION['gdpassword']) and !isset($_SESSION["gdaccess"]))
        {
...
directory and cannot be above the location of music.php within the
directory structure.
*/
$startdir = '../../../../media/Movies';
...
<div id="container">
  ...
  <div id="breadcrumbs"> <a href="<?php echo "../";?>">home</a>
  <?php
  ...
  <div id="listingcontainer">
	...
	?>
	<div><a href="<?php echo $fileurl;?>" class="<?php echo $class;?>"<?php echo $thumb2;?>><img src="<?php echo $includeurl; ?>dlf/<?php echo $icon;?>" alt="<?php echo $files[$i];?>" /><strong><?php echo $filename;?></strong> <?php echo date ("M d Y", filemtime($includeurl.$leadon.$files[$i]));?><?php echo $thumb;?></a></div>
	<?php
		if($class=='b') $class='w';
		else $class = 'b';	
	}	
