<?php
    ...
    if (!isset($_SESSION['gdusername']) and !isset($_SESSION['gdpassword']) and !isset($_SESSION["gdaccess"]))
        {
            echo "test access " .  $_SESSION["gdaccess"];
    	echo "<H1>You are not logged in - <A href = \"../login.php\">login</A></h1></h1>";
        }else
        { //echo " You are on this page " . $_SERVER['SCRIPT_NAME'];
               if(checkAccess($_SESSION["gdaccess"])){
/*
...
<?php
                   ...
                   echo "Your current access does not allow you to view this directory.";
               }
        }
?>